-- lock tree (light)
-- source:
--   https://github.com/NikolayS/postgres_dba/blob/master/sql/l1_lock_trees.sql
--   https://github.com/dataegret/pg-utils/blob/master/sql/locktree.sql
--   NOTE: The paths won't be precise but this query is very light and may be used quite frequently
